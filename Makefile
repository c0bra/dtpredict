# This Makefile is for the DateTime::Event::Predict extension to perl.
#
...
#     ABSTRACT => q[Predict new dates from a set of dates]
#     AUTHOR => q[Brian Hann <brian.hann+dtp@gmail.com>]
#     DIR => []
#     DISTNAME => q[DateTime-Event-Predict]
#     NAME => q[DateTime::Event::Predict]
#     NO_META => q[1]
#     PL_FILES => {  }
...
#     test => { TESTS=>q[t/00-load.t t/01-buckets.t t/boilerplate.t t/pod-coverage.t t/pod.t] }
...
NAME_SYM = DateTime_Event_Predict
VERSION = 0.01
...
MAKE = make
FULLEXT = DateTime/Event/Predict
BASEEXT = Predict
PARENT_NAME = DateTime::Event
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/DateTime/Event/Predict.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/DateTime/Event
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/DateTime/Event
...
TO_INST_PM = lib/DateTime/Event/Predict.pm

PM_TO_BLIB = lib/DateTime/Event/Predict.pm \
...
DISTNAME = DateTime-Event-Predict
DISTVNAME = DateTime-Event-Predict-0.01
...
manifypods : pure_all  \
	lib/DateTime/Event/Predict.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/DateTime/Event/Predict.pm $(INST_MAN3DIR)/DateTime::Event::Predict.$(MAN3EXT) 
...
TEST_FILE = test.pl
TEST_FILES = t/00-load.t t/01-buckets.t t/boilerplate.t t/pod-coverage.t t/pod.t
TESTDB_SW = -d
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Predict new dates from a set of dates</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Brian Hann &lt;brian.hann+dtp@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/DateTime/Event/Predict.pm blib/lib/DateTime/Event/Predict.pm 
